...
class OgrenciKonuDetay extends StatefulWidget {
  final int id;
  ...
  @override
  _OgrenciKonuDetayState createState() => _OgrenciKonuDetayState();
}

class _OgrenciKonuDetayState extends State<OgrenciKonuDetay> {
  @override
