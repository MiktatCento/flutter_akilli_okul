...
class OgrenciWidgetTest extends StatefulWidget {
  @override
  OgrenciWidgetTestState createState() => OgrenciWidgetTestState();
}

class OgrenciWidgetTestState extends State<OgrenciWidgetTest> {
      @override
