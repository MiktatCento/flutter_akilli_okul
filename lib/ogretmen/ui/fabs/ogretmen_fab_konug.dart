...
class OgretmenFabKonug extends StatefulWidget {
  @override
  _OgretmenFabKonugState createState() => _OgretmenFabKonugState();
}

class _OgretmenFabKonugState extends State<OgretmenFabKonug> {
  @override
