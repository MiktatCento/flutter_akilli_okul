import 'package:akilli_okul/login/changepass_veli.dart';
...
class VeliDrawer extends StatefulWidget {
  void innerKeyAc() {
    print("key açıldı");
    Ayarlar().klavyeKapat();
  ...
  @override
  _VeliDrawerState createState() => _VeliDrawerState();
}

class _VeliDrawerState extends State<VeliDrawer> {
  @override
  void initState() {
    sinavdami = false;
    anasayfadami = true;
                  ...
                  children: <Widget>[
                    ListTileTheme(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          if (bulunduguSayfa != ChangePassVeli()) {
                            setState(() {
                              bulunduguSayfa = ChangePassVeli();
                              sinavdami = true;
                              anasayfadami = false;
                            });
                          }
